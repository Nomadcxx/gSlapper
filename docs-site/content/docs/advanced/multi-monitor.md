...
description: "gSlapper provides full support for multiple displays, allowing you to set different wallpapers on each monitor or use the same wallpaper across all displays."
---
...
**See also**: [Systemd Service Setup](../systemd-service-setup) for full guide
