---
title: Systemd Service Setup for gSlapper
description: "gSlapper can run as a systemd user service, similar to how swww-daemon works. This allows automatic wallpaper restoration on login."
---
