---
title: Persistent Wallpapers in Wayland
description: "This guide explains how to set up persistent wallpapers (both video and static images) that automatically restore after reboot or login in Wayland."
---
...
**See also:** [Systemd Service Setup](../systemd-service-setup) for detailed instructions.
...
- [Systemd Service Setup](../systemd-service-setup) - Detailed systemd configuration
- [Video Wallpapers](./video-wallpapers) - Video wallpaper guide
- [Static Images](./static-images) - Static image guide
- [Multi-Monitor Setup](../advanced/multi-monitor) - Multi-monitor configuration
- [Command Line Options](./command-line-options) - All available options
