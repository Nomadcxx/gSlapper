...
description: "This guide helps users migrate from other wallpaper tools to gSlapper. Whether you're coming from swww, mpvpaper, hyprpaper, swaybg, or feh, we'll show you how "
---
...
- **[Quick Start Guide](./getting-started/quick-start)** - Get started with gSlapper
- **[Command Line Options](./user-guide/command-line-options)** - Full CLI reference
- **[Systemd Service Setup](./systemd-service-setup)** - Persistent wallpapers guide
- **[Persistent Wallpapers](./user-guide/persistent-wallpapers)** - Advanced persistence methods
- **[IPC Control](./user-guide/ipc-control)** - Runtime control guide
