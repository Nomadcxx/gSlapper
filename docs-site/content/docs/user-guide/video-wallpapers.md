...
description: "gSlapper supports all video formats that GStreamer can decode, including MP4, MKV, WebM, AVI, MOV, and more."
---
...
To make your video wallpaper automatically restore after reboot or login, see the [Persistent Wallpapers](./persistent-wallpapers) guide. The guide covers multiple methods including systemd service setup, shell scripts, and compositor-specific configuration.
