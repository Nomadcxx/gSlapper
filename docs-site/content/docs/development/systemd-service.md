---
title: Systemd Service (Development Documentation)
description: "Overview of gSlapper's systemd service integration for wallpaper restoration on login."
---
...
- **[Systemd Service Setup (User Guide)](../systemd-service-setup)** - End-user setup guide
