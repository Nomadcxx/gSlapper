---
title: API Reference
description: "This document provides a comprehensive reference for gSlapper's public APIs, internal functions, and data structures."
---

This document provides a comprehensive reference for gSlapper's public APIs, internal functions, and data structures.

**Note**: This is a developer-facing API reference. For user-facing command-line options, see [Command Line Options](./command-line-options).
...
- [Architecture Documentation](../development/architecture) - Detailed architecture overview
- [Command Line Options](./command-line-options) - User-facing CLI reference
- [IPC Control Guide](./ipc-control) - Using IPC from scripts
- [Persistent Wallpapers](./persistent-wallpapers) - State management usage
